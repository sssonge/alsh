...
OWNER_NAME = getenv("OWNER_NAME", "ali")
...
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "dahher")
GROUP_SUPPORT = getenv("GROUP_SUPPORT", "tttsst")
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "aaaoao")
